...
<body>
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span>SPARKS BANK</b></h2>
  </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <button onclick="location.href='./php/transfermoney.php'" style="color:black" class="waves-effect waves-light #ffab00 amber accent-4 btn-large"><b>Make a Transaction</b><i class="material-icons right">add_circle</i></button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="https://payspacemagazine.com/wp-content/uploads/2018/10/bank4-1.jpg">
            </div>
            <br />

            <h5><b>Welcome to SPARKS Bank !</b></h5>
            <br />
  ...
  <footer class="center footer">
    <h6 class="info"><b>2021 © Made by Nishaanth N K </b></h6>
